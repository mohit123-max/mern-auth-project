...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0 text-white '>
        ...
        {userData ? 
        (<div className="w-8 h-8 rounded-full bg-blue-800 flex justify-center items-center relative group">
          {userData.name[0].toUpperCase()}
          <div className="absolute top-0 right-0 hidden group-hover:block z-10 pt-10">
